...
Использовал catch2 для мини-теста, https://github.com/HowardHinnant/date и rapidjson.
4кк укороченных записей генерил питончиком, обрабатывается за несколько секунд на еле-живом ноуте.